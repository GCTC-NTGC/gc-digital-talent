...
import {
  ...
  type ExternalSizeOfOrganization,
  type ExternalRoleSeniority,
  type GovEmployeeType,
  type CafForce,
  type CafRank,
  type CafEmploymentType,
  type GovPositionType,
  type GovContractorRoleSeniority,
  type GovContractorType,
  type CSuiteRoleTitle,
