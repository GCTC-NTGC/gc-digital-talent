...
const Header = ({ experienceType }: HeaderProps) => {
  ...
  return (
    <Card space="md" className="relative">
      <div className="absolute top-0 right-0 h-[50px] w-[50px] bg-gray-100 drop-shadow-[1rem_-10px_5px_var(--gcdt-color-gray-100)] dark:bg-gray-700 dark:drop-shadow-[1rem_-10px_5px_var(--gcdt-color-gray-700)]">
        <div
          id="corner-shape"
