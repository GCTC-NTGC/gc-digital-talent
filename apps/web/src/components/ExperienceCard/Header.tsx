  ...
  return (
    <Card space="md" className="relative">
      <div className="absolute top-0 right-0 h-[50px] w-[50px] bg-gray-100">
        ...
        ></div>
        <div className="absolute top-0 right-0 flex h-8 w-8 items-center justify-center rounded-full bg-white">
          <Icon
            aria-hidden="true"
            focusable="false"
            className="absolute top-[0.2.5em] right-[0.2.5rem] h-6 w-6"
          />
        </div>
      </div>
