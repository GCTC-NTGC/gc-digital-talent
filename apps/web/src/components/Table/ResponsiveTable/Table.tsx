...
const Row = (props: RowProps) => (
  <tr
    ...
    data-h2-background-color="base:children[*:nth-child(even)](background.dark.50) base:dark:children[*:nth-child(even)](white.3) base:children[*:nth-child(odd)](foreground)"
