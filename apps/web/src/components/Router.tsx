  ...
  createBrowserRouter([
    ...
    },
    {
      ...
      children: [
        {
          index: true,
          lazy: () => import("../pages/AdminDashboardPage/AdminDashboardPage"),
        },
        {
          path: "users",
          children: [
            {
              index: true,
              lazy: () => import("../pages/Users/IndexUserPage/IndexUserPage"),
            },
            {
              path: ":userId",
        ...
        },
        {
          ...
          children: [
            {
              index: true,
              lazy: () => import("../pages/Teams/IndexTeamPage/IndexTeamPage"),
            },
            {
              path: "create",
              lazy: () =>
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  path: "members",
                  lazy: () =>
                    import("../pages/Teams/TeamMembersPage/TeamMembersPage"),
                },
              ],
            },
          ],
        },
        {
          ...
          children: [
            {
              index: true,
              lazy: () => import("../pages/Pools/IndexPoolPage/IndexPoolPage"),
            },
            {
              path: "create",
              lazy: () =>
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  path: "manage-access",
                  lazy: () =>
                    import("../pages/Pools/ManageAccessPage/ManageAccessPage"),
                },
                {
                  path: "plan",
                  lazy: () =>
              ...
              children: [
                {
                  index: true,
                  lazy: () =>
                    import("../pages/Classifications/IndexClassificationPage"),
                },
                {
                  path: "create",
                  lazy: () =>
                    import("../pages/Classifications/CreateClassificationPage"),
                },
                {
                  ...
                  children: [
                    {
                      index: true,
                      lazy: () =>
                        import("../pages/SkillFamilies/ViewSkillFamilyPage"),
                    },
                    {
                      path: "edit",
                      lazy: () =>
                        import("../pages/SkillFamilies/UpdateSkillFamilyPage"),
                    },
                  ],
                },
              ],
