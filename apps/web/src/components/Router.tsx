                    ...
                    children: [
                      {
                        index: true,
                        lazy: () =>
                          import("../pages/Skills/SkillPortfolioPage"),
                      },
                      {
                        path: ":skillId",
                        lazy: () =>
                          import("../pages/Skills/UpdateUserSkillPage"),
                      },
                      {
                        path: "showcase",
                        children: [
              ...
              },
              {
                ...
                children: [
                  ...
                  },
                  {
                    path: ":applicationId",
                    lazy: () =>
                      import("../pages/Applications/ApplicationLayout"),
                    children: [
                      {
                        path: "welcome",
                        lazy: () =>
                        ...
                        children: [
                          {
                            index: true,
                            lazy: () =>
                              import("../pages/Skills/IndexSkillPage"),
                          },
                          {
                            path: "create",
                            lazy: () =>
                              import("../pages/Skills/CreateSkillPage"),
                          },
                          {
                            path: ":skillId",
                            children: [
