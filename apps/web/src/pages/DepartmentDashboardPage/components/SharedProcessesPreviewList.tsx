...
export const SharedProcessesPreviewList_Fragment = graphql(/* GraphQL */ `
  fragment SharedProcessesPreviewList on Pool {
    id
    name {
      localized
    }
...
interface SharedProcessesPreviewListProps {
  sharedProcessesQuery: FragmentType<
    typeof SharedProcessesPreviewList_Fragment
  >[];
}

const SharedProcessesPreviewList = ({
  sharedProcessesQuery,
}: SharedProcessesPreviewListProps) => {
  const intl = useIntl();
  const paths = useRoutes();

  const processes = getFragment(
    SharedProcessesPreviewList_Fragment,
    sharedProcessesQuery,
  );
...
export default SharedProcessesPreviewList;
