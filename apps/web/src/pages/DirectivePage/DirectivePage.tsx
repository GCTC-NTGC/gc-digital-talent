...
import recruitmentEn from "~/assets/documents/Digital_Recruitment_Template_EN.docx?url";
import recruitmentFr from "~/assets/documents/Modele_de_recrutement_numerique_FR.docx?url";
import guidanceEn from "~/assets/documents/Enabling_Conditions_Guidance_EN.docx?url";
import guidanceFr from "~/assets/documents/Orientation_sur_les_conditions_habilitantes_FR.docx?url";
