  ...
  return (
    <>
      ...
      <div
        ...
        className="my-20"
      >
        <Heading Icon={MapIcon} size="h3" color="tertiary" className="mb-6">
          {intl.formatMessage({
        ...
        <div className="mt-6 grid gap-12 sm:mt-12 sm:grid-cols-2 sm:gap-20 md:grid-cols-3">
          <CardFlat
            color="quaternary"
          ...
          <CardFlat
            ...
            title={intl.formatMessage({
              ...
              id: "QVWGaL",
              description: "Heading for the digital Services contracting form",
            })}
