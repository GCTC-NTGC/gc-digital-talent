    ...
    <>
      ...
      >
        {!iapMode ? (
          <>
            {/* Standard copy */}
            <Heading Icon={MapIcon} color="primary" level="h2">
              {intl.formatMessage({
            ...
            <Heading Icon={PencilSquareIcon} color="secondary" level="h3">
              {intl.formatMessage({
            ...
            <Heading Icon={ShieldCheckIcon} color="quaternary" level="h3">
              {intl.formatMessage({
