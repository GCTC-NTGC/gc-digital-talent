...
import PersonalInformationSnapshot from "~/components/ApplicationSnapshot/Sections/PersonalInformation/PersonalInformationSnapshot";
import EducationRequirementSnapshot from "~/components/ApplicationSnapshot/Sections/EducationRequirment/EducationRequirementSnapshot";
import LanguageProfileSnapshot from "~/components/ApplicationSnapshot/Sections/LanguageProfile/LanguageProfileSnapshot";
import GovernmentInformationSnapshot from "~/components/ApplicationSnapshot/Sections/GovernmentInformation/GovernmentInformationSnapshot";
import DiversityEquityInclusionSnapshot from "~/components/ApplicationSnapshot/Sections/DiversityEquityInclusion/DiversityEquityInclusionSnapshot";
import WorkPreferencesSnapshot from "~/components/ApplicationSnapshot/Sections/WorkPreferences/WorkPreferencesSnapshot";
import CitizenVeteranPrioritySnapshot from "~/components/ApplicationSnapshot/Sections/CitizenVeteranPriority/CitizenVeteranPrioritySnapshot";
