    ...
    >
      ...
      >
        <div className="relative flex w-full flex-col">
          ...
          />
          <div className="relative z-[2] -mb-12 w-full bg-linear-to-b from-primary-700 from-90% to-transparent px-12 pt-7 pb-18 xs:-mb-27 xs:from-60% xs:pt-12 xs:pb-6 sm:-mb-26 sm:from-30% sm:pb-0 md:mb-0 md:h-0 md:overflow-visible md:bg-transparent md:p-0">
