...
import packageEnDoc from "~/assets/documents/Manager package - ITAPIP.pptx?url";
import packageFrDoc from "~/assets/documents/Trousse du gestionnaire - PATIPA.pptx?url";
