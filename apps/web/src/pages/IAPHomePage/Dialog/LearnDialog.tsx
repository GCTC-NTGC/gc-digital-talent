      ...
      <Dialog.Content>
        <Dialog.Header color="ia-secondary">
          {intl.formatMessage(
            {
              defaultMessage:
                "Learn More About the Government of Canada {ITAbbr} Apprenticeship Program for Indigenous Peoples",
              id: "C3U0TO",
        ...
        >
          {intl.formatMessage(
            {
              defaultMessage:
                "Who can apply to become an apprentice as part of the Government of Canada {ITAbbr} Apprenticeship Program for Indigenous Peoples?",
              id: "fYdKK4",
