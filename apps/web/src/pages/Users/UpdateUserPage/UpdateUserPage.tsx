...
const context: Partial<OperationContext> = {
  additionalTypenames: ["Role", "UserAuthInfo"], // This lets urql know when to invalidate cache if request returns empty list. https://formidable.com/open-source/urql/docs/basics/document-caching/#document-cache-gotchas
