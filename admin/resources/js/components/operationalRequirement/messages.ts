...
export default defineMessages({
  ...
  createSuccess: {
    id: "operationalRequirement.form.createSuccess",
  ...
  updateError: {
    id: "operationalRequirement.form.updateError",
  ...
  operationalRequirementNotFound: {
    id: "operationalRequirement.form.operationalRequirementNotFound",
    defaultMessage:
