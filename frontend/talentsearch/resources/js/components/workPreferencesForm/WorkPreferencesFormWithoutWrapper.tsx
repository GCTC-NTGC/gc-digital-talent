...
export const WorkPreferencesFormWithoutWrapper: React.FunctionComponent<{
...
export const WorkPreferencesFormWithoutWrapperApi: React.FunctionComponent =
  () => {
...
export default WorkPreferencesFormWithoutWrapper;
