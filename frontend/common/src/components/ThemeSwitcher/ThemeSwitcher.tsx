...
const ThemeSwitcher = () => {
  ...
  useEffect(() => {
    function testDark() {
      if (isDark) {
        setDOMTheme("dark", hydrogen);
      } else {
        setDOMTheme("", hydrogen);
      }
    }
    window
  ...
  }, [hydrogen, isDark, isSet, isSetDark, isSetLight, prefersDark, switcher]);
