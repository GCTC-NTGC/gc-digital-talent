...
const candidateFacingScreeningStage = defineMessages({
  [ScreeningStage.NewApplication]: {
    defaultMessage: "Received",
    id: "j1ehms",
    description: "Candidate facing screening stage, new application",
  },
  [ScreeningStage.ApplicationReview]: {
    defaultMessage: "Under review",
    id: "ABKVIt",
    description: "Candidate facing screening stage, application review",
  },
  [ScreeningStage.ScreenedIn]: {
    defaultMessage: "Application reviewed",
    id: "Dos5Y1",
    description: "Candidate facing screening stage, screened in",
  },
  [ScreeningStage.UnderAssessment]: {
    defaultMessage: "Under assessment",
    id: "xSmuoq",
    description: "Candidate facing screening stage, under assessment",
  },
});

export const getCandidateFacingScreeningStage = (
  screeningStage: string,
): MessageDescriptor => {
  return getOrDisplayError(
    candidateFacingScreeningStage,
    screeningStage,
    `Invalid screening stage '${screeningStage}'`,
  );
};

const candidateFacingScreeningStageDesc = defineMessages({
  [ScreeningStage.NewApplication]: {
    defaultMessage:
      "Your application has been submitted and is awaiting review. You can’t edit your application anymore.",
    id: "mu5nNC",
    description:
      "Candidate facing screening stage description, new application",
  },
  [ScreeningStage.ApplicationReview]: {
    defaultMessage: "We’re currently reviewing your application.",
    id: "o/moLc",
    description:
      "Candidate facing screening stage description, application review",
  },
  [ScreeningStage.ScreenedIn]: {
    defaultMessage:
    ...
    id: "5QSLe+",
    description: "Candidate facing screening stage description, screened in",
  },
  [ScreeningStage.UnderAssessment]: {
    defaultMessage:
    ...
    id: "6V4VeF",
    description:
      "Candidate facing screening stage description, under assessment",
  },
});

export const getCandidateFacingScreeningStageDesc = (
  screeningStage: string,
): MessageDescriptor => {
  return getOrDisplayError(
    candidateFacingScreeningStageDesc,
    screeningStage,
    `Invalid screening stage '${screeningStage}'`,
  );
};
