...
const commonStyles = {
  "data-h2-background-color":
    "base(transparent) base:all:selectors[.active](secondary.darker) base:focus-visible(focus) base:all:hover(secondary.darker) base:iap(secondary.light) base:iap:selectors[.active](secondary.lighter.10) base:iap:focus-visible(focus) base:iap:hover(secondary.lighter.30)",
