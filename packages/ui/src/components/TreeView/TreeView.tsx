...
const Item = ({ noBranch, children, ...rest }: TreeViewItemProps) => (
  <div
    ...
    data-h2-border-left="base:selectors[:not(:last-child)](1px solid tertiary.darker) base:selectors[:last-child:before](1px solid tertiary.darker)"
    ...
    data-h2-border-bottom="base:selectors[::before](1px solid tertiary.darker)"
