...
class KeywordSearchBetaTest extends TestCase
{
    ...
    public function testUserSearchByWorkExperience()
    {
        ...
        ', [
                'where' => [
                    'generalSearchBeta' => 'software developer', // verify it is case insensitive
                ],
            ])->assertJson([
                'data' => [
                    'usersPaginated' => [
    ...
    public function testUserSearchByAwardAndCommunityExperience()
    {
        ...
        ', [
                'where' => [
                    'generalSearchBeta' => 'community title',
                ],
            ])->assertJson([
                'data' => [
                    'usersPaginated' => [
    ...
    public function testUserSearchPartialNamesEmailsWithOrLogic()
    {
        ...
        $this->actingAs($this->platformAdmin, 'api')->graphQL(
            ...
            '
             ...
             ', [
                'where' => [
                    'generalSearchBeta' => 'abc OR johnson@test',
                ],
            ])->assertJsonFragment([
                'id' => $user1->id,
            ])->assertJsonFragment([
        ...
        $this->actingAs($this->platformAdmin, 'api')->graphQL(
            ...
            '
             ...
             ', [
                'where' => [
                    'generalSearchBeta' => 'johnso or hal',
                ],
            ])->assertJsonFragment([
                'id' => $user2->id,
            ])->assertJsonFragment([
        ...
        $this->actingAs($this->platformAdmin, 'api')->graphQL(
            ...
            '
             ...
             ', [
                'where' => [
                    'generalSearchBeta' => 'BOB@ OR johnson@',
                ],
            ])->assertJsonFragment([
                'id' => $user2->id,
            ])->assertJsonFragment([
    ...
    public function testUserSearchPartialNamesEmailsWithQuotes()
    {
        ...
        $this->actingAs($this->platformAdmin, 'api')->graphQL(
            ...
            '
             ...
             ', [
                'where' => [
                    'generalSearchBeta' => '"johnson" OR john@',
                ],
            ])->assertJsonFragment([
                'id' => $user1->id,
            ])->assertJsonFragment([
    ...
    public function testUserSearchNamesEmailsWithNegativeSearch()
    {
        ...
        $this->actingAs($this->platformAdmin, 'api')->graphQL(
            ...
            '
             ...
             ', [
                'where' => [
                    'generalSearchBeta' => 'john -bob@test.com',
                ],
            ])->assertJsonFragment([
                'id' => $user1->id,
            ])->assertJsonFragment([
        ...
        $this->actingAs($this->platformAdmin, 'api')->graphQL(
            ...
            '
                ...
                ', [
                'where' => [
                    'generalSearchBeta' => 'john -smit -bob@t',
                ],
            ])->assertJsonFragment([
                'id' => $user1->id,
            ])->assertJsonFragment([
