...
class PoolCandidateTest extends TestCase
{
  ...
  public function testFilterByClassification(): void
  {
    ...
    PoolCandidate::factory()->count(2)->create(['expiry_date' => FAR_FUTURE_DATE])->each(function($candidate) use ($classification) {
  ...
  public function testFilterByCmoAsset(): void
  {
    ...
    PoolCandidate::factory()->count(5)->create(['expiry_date' => FAR_FUTURE_DATE]);

    // Create new cmoAsset and attach to two new pool candidates.
    $cmoAsset = CmoAsset::factory()->create([
      'key' => 'new_cmo_asset'
    ]);
    PoolCandidate::factory()->count(2)->create(['expiry_date' => FAR_FUTURE_DATE])->each(function($candidate) use ($cmoAsset) {
  ...
  public function testFilterByPool(): void
  {
    ...
    PoolCandidate::factory()->count(2)->create(['expiry_date' => FAR_FUTURE_DATE])->each(function($candidate) use ($pool) {
