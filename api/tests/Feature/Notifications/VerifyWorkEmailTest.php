...
class VerifyWorkEmailTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function testSendNotificationsVerifyWorkEmail(): void
    {
        ...
        // command successful
        $exitCode = Artisan::call('send-notifications:verify-work-email');
