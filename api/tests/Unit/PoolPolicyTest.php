...
class PoolPolicyTest extends TestCase
{
    ...
    public function testCreate()
    {
        ...
        $this->assertTrue($this->processOperatorUser->can('create', [Pool::class, $createPoolInput]));
        ...
        $this->assertFalse($this->processOperatorUser->can('create', [Pool::class, $createOtherPoolInput]));
    ...
    {
        $this->assertTrue($this->processOperatorUser->can('duplicate', $this->teamPool));
        ...
        $this->assertFalse($this->processOperatorUser->can('duplicate', $this->unOwnedPool));
    ...
    public function testDeleteDraft()
    {
        ...
        $this->assertTrue($this->processOperatorUser->can('deleteDraft', $this->teamPool));
    ...
    {
        $this->assertTrue($this->processOperatorUser->can('archiveAndUnarchive', $this->teamPool));
