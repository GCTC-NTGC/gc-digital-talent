        ...
        if ($type === WorkExperience::class) {
            ...
            if ($experience->employment_category === EmploymentCategory::EXTERNAL_ORGANIZATION->name) {
                ...
                if ($experience->supervisory_position === true) {
                    ...
                    $this->addLabelText($section, $this->localize('headings.senior_management_status'), $experience->senior_management_status ? Lang::get('senior_management_true') : Lang::get('senior_management_false'));
