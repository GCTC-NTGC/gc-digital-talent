...
final class CreateTalentNominationInputValidator extends Validator
{
    ...
    public function messages(): array
    {
        return [
            ...
            'advancementReference.connect.exists' => ApiErrorEnums::REFERENCE_NOT_FOUND,
            'advancementReferenceFallbackClassification.connect.exists' => ApiErrorEnums::REFERENCE_CLASSIFICATION_NOT_FOUND,
            'advancementReferenceFallbackDepartment.connect.exists' => ApiErrorEnums::REFERENCE_DEPARTMENT_NOT_FOUND,
