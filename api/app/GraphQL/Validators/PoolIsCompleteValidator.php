...
final class PoolIsCompleteValidator extends Validator
{
    ...
    public function messages(): array
    {
        return [
            ...
            'closing_date.required' => ApiError::PROCESS_CLOSING_DATE_REQUIRED->localizedErrorMessage(), ,
            'closing_date.after' => ApiError::PROCESS_CLOSING_DATE_FUTURE->localizedErrorMessage(),
            'advertisement_location.*.required_if' => ApiError::PROCESS_LOCATION_REQUIRED->localizedErrorMessage(),
            'advertisement_location.*.required_with' => ApiError::PROCESS_LOCATION_BOTH_LANGUAGES_REQUIRED->localizedErrorMessage(),
            'essential_skills.required' => ApiError::PROCESS_ESSENTIAL_SKILL_REQUIRED->localizedErrorMessage(),
            'key_tasks.en.required' => ApiError::PROCESS_WORK_TASKS_EN_REQUIRED->localizedErrorMessage(),
            'key_tasks.fr.required' => ApiError::PROCESS_WORK_TASKS_FR_REQUIRED->localizedErrorMessage(),
            'your_impact.en.required' => ApiError::PROCESS_YOUR_IMPACT_EN_REQUIRED->localizedErrorMessage(),
            'your_impact.fr.required' => ApiError::PROCESS_YOUR_IMPACT_FR_REQUIRED->localizedErrorMessage(),
            'special_note.en.required' => ApiError::PROCESS_SPECIAL_NOTE_EN_REQUIRED->localizedErrorMessage(),
            'special_note.fr.required' => ApiError::PROCESS_SPECIAL_NOTE_FR_REQUIRED->localizedErrorMessage(),
        ];
    }
}
