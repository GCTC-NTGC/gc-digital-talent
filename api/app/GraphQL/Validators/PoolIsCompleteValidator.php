...
final class PoolIsCompleteValidator extends Validator
{
    ...
    public function messages(): array
    {
        return [
            ...
            'closing_date.required' => ErrorCode::CLOSING_DATE_REQUIRED->name,
            'closing_date.after' => ErrorCode::CLOSING_DATE_FUTURE->name,
            'advertisement_location.*.required_if' => ErrorCode::LOCATION_REQUIRED->name,
            ...
            'essential_skills.required' => ErrorCode::ESSENTIAL_SKILL_REQUIRED->name,
            ...
            'key_tasks.en.required' => ErrorCode::ENGLISH_KEY_TASKS_REQUIRED->name,
            'key_tasks.fr.required' => ErrorCode::FRENCH_KEY_TASKS_REQUIRED->name,
            'your_impact.en.required' => ErrorCode::ENGLISH_YOUR_IMPACT_REQUIRED->name,
            'your_impact.fr.required' => ErrorCode::FRENCH_YOUR_IMPACT_REQUIRED->name,
            'special_note.en.required' => ErrorCode::ENGLISH_SPECIAL_NOTE_REQUIRED->name,
            'special_note.fr.required' => ErrorCode::FRENCH_SPECIAL_NOTE_REQUIRED->name,
            'area_of_selection.required' => ErrorCode::POOL_AREA_OF_SELECTION_REQUIRED->name,
            'contact_email' => ErrorCode::CONTACT_EMAIL_REQUIRED->name,
        ];
    }
}
