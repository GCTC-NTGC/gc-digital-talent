...
class UserResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'first_official_language' => $this->first_official_language,
            'second_language_exam_completed' => $this->second_language_exam_completed,
            'second_language_exam_validity' => $this->second_language_exam_validity,
