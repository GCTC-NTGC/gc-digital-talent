...
class SkillSeeder extends Seeder
{
    ...
    public static function parseKeywords($keywordString)
    {
    ...
    public function run()
    {
        ...
        $skillsProvidedData = [
            ...
            [
                ...
                'keywords_fr' => 'Fiabilité; Confiance; Crédibilité; Cohérence',
            ],
            [
            ...
            [
                ...
                'skill_definition_fr' => 'Apprécier les qualités et les points de vue uniques que des personnes d’origines différentes apportent à une équipe.',
            ...
            [
                ...
                'keywords_fr' => 'Trouver des solutions; Résoudre des problèmes; Faire face à des problèmes; Dépanner',
            ],
            [
        ...
        // associations between skills and skill families: many-to-many
        $skillsToSkillFamiiesProvidedData = [
            [
                'skill_name_en' => '.NET Programming',
                'skill_family_name_en' => 'Programming Languages and Tools',
            ],
            [
                'skill_name_en' => 'Adobe XD',
                'skill_family_name_en' => 'Programming Languages and Tools',
            ...
            [
                'skill_name_en' => 'API Design',
                'skill_family_name_en' => 'Development and Programming',
            ],
            [
                'skill_name_en' => 'Application Development',
                'skill_family_name_en' => 'Development and Programming',
            ...
            [
                'skill_name_en' => 'Business Analysis',
                'skill_family_name_en' => 'Technical Advising',
            ],
            [
                'skill_name_en' => 'Data Cleaning',
                'skill_family_name_en' => 'Development and Programming',
            ...
            [
                'skill_name_en' => 'Business Analysis',
                'skill_family_name_en' => 'User Experience and Interface Design',
            ],
            [
                'skill_name_en' => 'Version Control',
                'skill_family_name_en' => 'Development and Programming',
            ...
            [
                'skill_name_en' => 'Application Architecture',
                'skill_family_name_en' => 'IT Architecture',
            ],
            [
                'skill_name_en' => 'Cloud Architecture',
                'skill_family_name_en' => 'IT Architecture',
            ...
            [
                'skill_name_en' => 'Data Analysis',
                'skill_family_name_en' => 'Database Design & Data Administration',
            ],
            [
                'skill_name_en' => 'Information Technology Systems and Solutions',
                'skill_family_name_en' => 'IT Architecture',
            ...
            [
                'skill_name_en' => 'Agile Methodologies',
                'skill_family_name_en' => 'IT Project Management',
            ],
            [
                'skill_name_en' => 'Enhanced Management Framework for IT Projects',
                'skill_family_name_en' => 'IT Project Management',
            ...
            [
                'skill_name_en' => 'Enterprise Information Technology Architecture',
                'skill_family_name_en' => 'Infrastructure/Operations',
            ],
            [
                'skill_name_en' => 'Communication of Technical Information to Non-Technical Audiences',
                'skill_family_name_en' => 'Technical Advising',
            ...
            [
                'skill_name_en' => 'Implementation of GC Digital Standards in Operations',
                'skill_family_name_en' => 'IT Management',
            ],
            [
                'skill_name_en' => 'Inclusive Mindset',
                'skill_family_name_en' => 'Interpersonal',
            ],
            [
                'skill_name_en' => 'Digital Product Accessibility',
                'skill_family_name_en' => 'User Experience and Interface Design',
            ...
            [
                'skill_name_en' => 'Accreditation Procedures, Policies, and Practices',
                'skill_family_name_en' => 'IT Security',
            ],
            [
                'skill_name_en' => 'Application Access Management',
                'skill_family_name_en' => 'IT Security',
            ...
            [
                'skill_name_en' => 'Application of NIST controls',
                'skill_family_name_en' => 'Cyber Security',
            ],
            [
                'skill_name_en' => 'Cybersecurity Principles',
                'skill_family_name_en' => 'Cyber Security',
            ...
            [
                'skill_name_en' => 'Data Discovery and Profiling',
                'skill_family_name_en' => 'Information Management',
            ],
            [
                'skill_name_en' => 'Data Movement',
                'skill_family_name_en' => 'Information Management',
            ...
            [
                'skill_name_en' => 'Advice to Senior Management',
                'skill_family_name_en' => 'Leadership',
            ],
            [
                'skill_name_en' => 'Change Management',
                'skill_family_name_en' => 'Leadership',
            ...
            [
                'skill_name_en' => 'Respect for Diversity',
                'skill_family_name_en' => 'Working in Government',
            ],
            [
                'skill_name_en' => 'Team Leadership',
                'skill_family_name_en' => 'Leadership',
            ...
            [
                'skill_name_en' => 'Storytelling',
                'skill_family_name_en' => 'Communication',
            ],
            [
                'skill_name_en' => 'Verbal Communication',
                'skill_family_name_en' => 'Communication',
        ...
        $reshapedData = array_map(
            function ($skillRecord) use ($skillsToSkillFamiiesProvidedData) {
                // Take the provided data and reshape it to our data model
                $model = [
                    'key' => KeyStringHelpers::toKeyString(trim($skillRecord['skill_name_en']), '_'), // no key provided so making our own slug
                    'name' => [
                        'en' => trim($skillRecord['skill_name_en']),
                        'fr' => trim($skillRecord['skill_name_fr']),
                    ],
                    'description' => [
                        'en' => trim($skillRecord['skill_definition_en']),
                        'fr' => trim($skillRecord['skill_definition_fr']),
                    ],
                    'keywords' => [
                        'en' => SkillSeeder::parseKeywords($skillRecord['keywords_en']),
                        'fr' => SkillSeeder::parseKeywords($skillRecord['keywords_fr']),
                    ],
                ];
