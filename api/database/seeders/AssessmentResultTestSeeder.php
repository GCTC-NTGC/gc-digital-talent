...
class AssessmentResultTestSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $securityAnalystPool = Pool::select('id')->where('name->en', 'IT Security Analyst')->sole();
        $user1 = User::select('id')->where('first_name', 'User1')->sole();
        ...
        $user4 = User::select('id')->where('first_name', 'User4')->sole();
        ...
        $user5 = User::select('id')->where('first_name', 'User5')->sole();
        ...
        $user6 = User::select('id')->where('first_name', 'User6')->sole();
        ...
        $user7 = User::select('id')->where('first_name', 'User7')->sole();
        ...
        $user8 = User::select('id')->where('first_name', 'User8')->sole();
    ...
    public function assessSkillsWithLevelAndJustification($poolCandidate, $poolSkills, $assessmentStep, $level, $justifications, $assessmentDecision, $assessmentResultType)
    {
