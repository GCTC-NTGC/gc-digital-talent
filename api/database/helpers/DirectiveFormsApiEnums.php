...
class DirectiveFormsApiEnums
{
    ...
    const TECHNOLOGICAL_CHANGE_FACTOR_DIFFERENT_NATURE = 'DIFFERENT_NATURE';

    const TECHNOLOGICAL_CHANGE_FACTOR_CHANGE_DEPARTMENT_OPERATION = 'CHANGE_DEPARTMENT_OPERATION';

    const TECHNOLOGICAL_CHANGE_FACTOR_NEW_TECHNOLOGICAL_SYSTEM = 'NEW_TECHNOLOGICAL_SYSTEM';

    const TECHNOLOGICAL_CHANGE_FACTOR_CHANGED_TECHNOLOGICAL_SYSTEM = 'CHANGED_TECHNOLOGICAL_SYSTEM';

    /**
     * A collection of enums for TechnologicalChangeFactor in factories and seeders
     *
     * @return string[]
     */
    public static function technologicalChangeFactors(): array
    {
        return [
            self::TECHNOLOGICAL_CHANGE_FACTOR_DIFFERENT_NATURE,
            self::TECHNOLOGICAL_CHANGE_FACTOR_CHANGE_DEPARTMENT_OPERATION,
            self::TECHNOLOGICAL_CHANGE_FACTOR_NEW_TECHNOLOGICAL_SYSTEM,
            self::TECHNOLOGICAL_CHANGE_FACTOR_CHANGED_TECHNOLOGICAL_SYSTEM,
        ];
    }
