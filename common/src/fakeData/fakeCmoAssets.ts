...
export default (): CmoAsset[] => [
  {
    ...
    description: {
      en: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam pharetra tempus dictum.",
      fr: "Ipsé etiam commodo, dolor eu hendrerit suscipit, eros sem imperdiet leo, a vestibulum elit nulla nec nibh.",
    },
  },
  {
